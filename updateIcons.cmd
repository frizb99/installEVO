...
set roboOptions=/R:2 /W:10 /NDL /XO /NP
...
psexec \\%pc% -u %pseUser% -p %psePass% -e -n 10 -nobanner robocopy "%source%" "C:\!pgmFiles!" *.ico %roboOptions% 
...
if /i %serverName:~0,4% EQU will echo IP range for %serverName:~0,4% is 10.26
